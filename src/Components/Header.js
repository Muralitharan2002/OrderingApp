  ...
  return (
    <div className="flex justify-between items-center shadow-xl bg-gradient-to-r from-lime-500 via-lime-300 to-lime-500 rounded-lg m-4 sticky top-0 z-50">
      ...
      <div className="nav font-semibold text-xs relative lg:text-lg md:text-md xl:text-2xl">
        ...
        >
          <Link to="/main">
            <li className="px-2 border-b-2 border-yellow-50 border-opacity-0 hover:border-[#ea580c] text-zinc-800 hover:text-[#ea580c] font-semibold hover:duration-200 cursor-pointer active">
              Home
            </li>
          </Link>
          <Link to="/main/about">
          ...
          <Link to="/main/cart">
            <li className="border-b-2 border-yellow-50 border-opacity-0 hover:border-[#ea580c] text-zinc-800 hover:text-[#ea580c] font-semibold hover:duration-200 cursor-pointer active">
